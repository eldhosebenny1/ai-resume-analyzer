...
**CRITICAL START:**
Check if the "Resume" text above is actually a resume (contains work history, skills, education, etc.).
If it is NOT a resume (e.g. recipe, lyrics, book chapter, random text, code block),
RETURN ONLY THIS JSON:
{{
  "error": "This file does not appear to be a resume. Please upload a valid resume."
}}
If valid, proceed with the analysis below.
